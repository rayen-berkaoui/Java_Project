...
public class acceuil implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        postsListView.setCellFactory(lv -> new PostCell(activityService, commentService, this::filterByHashtag));
    ...
    private void openDetails(Post post) {
    ...
    private void updatePagination() {
        ...
        List<Post> pageItems = total == 0 ? new ArrayList<>() : allFilteredPosts.subList(fromIndex, toIndex);
