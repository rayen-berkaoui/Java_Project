...
public class PostService implements CRUD<Post> {
    ...
    public void ajouter(Post post) throws SQLException {
        String contentEncoded = Post.encodeForDb(post.getContent(), post.getHashtags());
    ...
    @Override
    public void modifie(int id, Post post) throws SQLException {
        String contentEncoded = Post.encodeForDb(post.getContent(), post.getHashtags());
    ...
    public List<Post> getPostsBetweenDates(LocalDateTime start, LocalDateTime end) throws SQLException {
        if (con == null) {
    ...
    public void displayPostsBetweenDates(LocalDateTime start, LocalDateTime end) {
        try {
            List<Post> posts = getPostsBetweenDates(start, end);
    ...
    public List<Post> searchPosts(String word) throws SQLException {
        if (con == null) {
    ...
    public List<Post> filterPosts(String searchText, String hashtag, LocalDateTime dateFrom, LocalDateTime dateTo) {
    ...
    public List<Post> filterPosts(String searchText, List<String> hashtags, LocalDateTime dateFrom, LocalDateTime dateTo) {
    ...
    private List<Post> filterPostsSimple(String searchText, List<String> hashtags, LocalDateTime dateFrom, LocalDateTime dateTo) {
        try {
            List<Post> list = searchText != null && !searchText.isBlank() ? searchPosts(searchText) : afficher();
            if (hashtags != null && !hashtags.isEmpty()) {
    ...
    private Post mapPost(ResultSet rs) throws SQLException {
        ...
        String[] decoded = Post.decodeFromDb(raw);
