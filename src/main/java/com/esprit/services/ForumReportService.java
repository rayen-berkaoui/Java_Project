...
public class ForumReportService {
    ...
    public void addReport(ForumReport report) throws SQLException {
    ...
    private ForumReport mapReport(ResultSet rs) throws SQLException {
    ...
    public ForumReport getReportById(int reportId) throws SQLException {
