    ...
    public void startRecording(TranscriptionListener listener) {
        ...
        recordingThread = new Thread(() -> {
            ...
            try {
                ...
                while (recording) {
                    ...
                    if (bytesRead > 0) {
                        if (recognizer.acceptWaveForm(buffer, bytesRead)) {
                            // A complete phrase was recognized
                ...
                if (listener != null) listener.onError("Erreur d'enregistrement: " + e.getMessage());
            } finally {
                recording = false;
                if (recognizer != null) {
        ...
        recordingThread.setName("vosk-voice-recognition");
