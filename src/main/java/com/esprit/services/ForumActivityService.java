...
import com.esprit.entities.ForumActivity;
import com.esprit.entities.ForumReactionType;
import com.esprit.utils.MyDataBase;
import com.esprit.services.ForumReportService;
...
public class ForumActivityService {
    ...
    public ForumActivityService() {
        this.con = MyDataBase.getInstance().getConnection();
    }

    public String toggleReaction(int postId, String userKey, ForumReactionType type) throws SQLException {
    ...
    public void toggleCommentReaction(int commentId, int postId, String userKey, ForumReactionType type) throws SQLException {
    ...
    public String reportPost(int postId, String userKey, String reason) throws SQLException {
        ...
        try {
            ...
            if (reportedUserKey != null) {
                ...
                ForumReportService reportService = new ForumReportService();
                reportService.addReport(report);

                System.out.println("✅ ForumReport saved to reports table with ID: " + report.getId());
            }
    ...
    public List<ForumActivity> getActivitiesByPost(int postId) throws SQLException {
        List<ForumActivity> list = new ArrayList<>();
