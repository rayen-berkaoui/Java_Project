...
public class DashboardController {
    ...
    private void loadAdminPaniers(Integer filterUserId) {
        ...
        for (Panier p : allPaniers) {
            ...
            row.getChildren().addAll(
                ...
                makeDataLabel(String.format("%.2f DT", p.getPrixEstime()), 70, "#51CF66"),
    ...
    private void loadAdminReservations(Integer filterUserId, String filterStatus) {
        ...
        for (Reservation r : allRes) {
            ...
            else if ("Paye".equalsIgnoreCase(sp) || "Pay\u00e9".equalsIgnoreCase(sp)) { paidCount++; totalRevenue += r.getMontantTotal(); }
        }
        ...
        for (Reservation r : allRes) {
            ...
            row.getChildren().addAll(
                ...
                makeDataLabel(String.format("%.2f DT", r.getMontantTotal()), 80, "#51CF66"),
            ...
            // APPROVE button - only for cash "En cours de paiement"
            if ("En cours de paiement".equalsIgnoreCase(statut)) {
