...
public class ForumPostCell extends ListCell<ForumPost> {
    ...
    private final ForumActivityService activityService;
    ...
    public ForumPostCell(ForumActivityService activityService, ForumCommentService commentService) {
        this(activityService, commentService, null);
    }

    public ForumPostCell(ForumActivityService activityService, ForumCommentService commentService, Consumer<String> onHashtagClick) {
    ...
    private VBox buildCard(ForumPost post) {
