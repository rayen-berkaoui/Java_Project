...
import com.esprit.services.ForumAdminService;
import com.esprit.services.ForumChatModerationService;
import com.esprit.services.ForumDashboardStatsService;
import com.esprit.services.ForumPostService;
import com.esprit.chat.ChatClient;
import com.esprit.chat.ChatWebSocketServer;
...
public class ForumAdminDashboardController implements Initializable {
    ...
    @FXML private TableColumn<ForumPost, Number> colPostId;
    @FXML private TableColumn<ForumPost, String> colPostContent;
    @FXML private TableColumn<ForumPost, String> colPostDate;
    @FXML private TableColumn<ForumPost, Void> colPostAction;
    @FXML private TableView<ForumComment> commentsTable;
    @FXML private TableColumn<ForumComment, Number> colCommentId;
    @FXML private TableColumn<ForumComment, Number> colCommentPostId;
    @FXML private TableColumn<ForumComment, String> colCommentContent;
    @FXML private TableColumn<ForumComment, String> colCommentUser;
    @FXML private TableColumn<ForumComment, String> colCommentDate;
    @FXML private TableColumn<ForumComment, Void> colCommentAction;
    ...
    @FXML private TableView<ForumChatModerationService.ChatViolation> violationsTable;
    @FXML private TableColumn<ForumChatModerationService.ChatViolation, Number> colViolId;
    @FXML private TableColumn<ForumChatModerationService.ChatViolation, String> colViolUser;
    @FXML private TableColumn<ForumChatModerationService.ChatViolation, String> colViolBadWord;
    @FXML private TableColumn<ForumChatModerationService.ChatViolation, String> colViolStatus;
    @FXML private TableColumn<ForumChatModerationService.ChatViolation, Void> colViolAction;
    ...
    @FXML private TableView<ForumChatModerationService.ChatBan> bannedUsersTable;
    @FXML private TableColumn<ForumChatModerationService.ChatBan, Number> colBanId;
    @FXML private TableColumn<ForumChatModerationService.ChatBan, String> colBanUser;
    @FXML private TableColumn<ForumChatModerationService.ChatBan, String> colBanReason;
    @FXML private TableColumn<ForumChatModerationService.ChatBan, String> colBanDate;
    @FXML private TableColumn<ForumChatModerationService.ChatBan, String> colBanUntil;
    @FXML private TableColumn<ForumChatModerationService.ChatBan, String> colBanRemaining;
    @FXML private TableColumn<ForumChatModerationService.ChatBan, String> colBanStatus;
    @FXML private TableColumn<ForumChatModerationService.ChatBan, Void> colBanAction;
    ...
    private final ForumAdminService adminService = new ForumAdminService();
    private final ForumPostService postService = new ForumPostService();
    private final ForumDashboardStatsService statsService = new ForumDashboardStatsService();
    private final ForumChatModerationService chatModerationService = new ForumChatModerationService();
    ...
    private void refreshTables() {
        try {
            List<ForumPost> posts = adminService.getAllPosts();
            postsTable.getItems().setAll(posts);
        } catch (SQLException e) {
            postsTable.getItems().clear();
        }
        try {
            List<ForumComment> comments = adminService.getAllComments();
    ...
    private void initPostsColumns() {
        ...
        colPostAction.setCellFactory(col -> {
            TableCell<ForumPost, Void> cell = new TableCell<>() {
                ...
                protected void updateItem(Void item, boolean empty) {
                    ...
                    if (empty || getTableRow() == null || getTableRow().getItem() == null) {
                        ...
                        ForumPost p = getTableRow().getItem();
    ...
    private void initCommentsColumns() {
        ...
        colCommentAction.setCellFactory(col -> {
            TableCell<ForumComment, Void> cell = new TableCell<>() {
                final Button btn = new Button("Supprimer");
                { btn.getStyleClass().add("dashboard-button-danger"); }
                @Override
                protected void updateItem(Void item, boolean empty) {
                    ...
                    if (empty || getTableRow() == null || getTableRow().getItem() == null) {
                        ...
                        ForumComment c = getTableRow().getItem();
        ...
        colViolAction.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(Void item, boolean empty) {
                ...
                if (empty || getTableRow() == null || getTableRow().getItem() == null) {
                    ...
                    ForumChatModerationService.ChatViolation v = getTableRow().getItem();
    ...
    private void refreshChatAlerts() {
        if (violationsTable == null) return;
        List<ForumChatModerationService.ChatViolation> violations = chatModerationService.getAllViolations();
    ...
    private void banChatUser(ForumChatModerationService.ChatViolation violation) {
        com.esprit.utils.ForumStyledDialog.textInput(
    ...
    private void resolveViolation(ForumChatModerationService.ChatViolation violation) {
        try {
        ...
        colBanAction.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(Void item, boolean empty) {
                ...
                if (empty || getTableRow() == null || getTableRow().getItem() == null) {
                    ...
                    ForumChatModerationService.ChatBan ban = getTableRow().getItem();
    ...
    private void refreshBannedUsers() {
        if (bannedUsersTable == null) return;
        List<ForumChatModerationService.ChatBan> bans = chatModerationService.getAllBans();
        bannedUsersTable.getItems().setAll(bans);
        long activeCount = bans.stream().filter(ForumChatModerationService.ChatBan::isActive).count();
        if (lblBanCount != null) {
    ...
    private void handleUnban(ForumChatModerationService.ChatBan ban) {
    ...
    private void handleExtendBan(ForumChatModerationService.ChatBan ban) {
        com.esprit.utils.ForumStyledDialog.textInput(
                "Prolonger le ban",
    ...
    private void refreshChatMessages() {
        ...
        List<ForumChatModerationService.ChatMessage> messages = chatModerationService.getRecentMessages(100);
        ...
        if (messages.isEmpty()) {
            ...
            int displayed = 0;
            for (ForumChatModerationService.ChatMessage msg : messages) {
                if (!filter.isEmpty()
    ...
    private javafx.scene.Node buildChatBubble(ForumChatModerationService.ChatMessage msg) {
    ...
    private boolean confirm(String message) {
        return com.esprit.utils.ForumStyledDialog.confirm(message);
    }
