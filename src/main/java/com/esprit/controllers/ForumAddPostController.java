...
import com.esprit.services.ForumContentModerationService;
import com.esprit.services.ForumPostService;
import com.esprit.services.ForumWarningService;
import com.esprit.utils.ForumMediaUtils;
...
public class ForumAddPostController implements Initializable {
    ...
    private final ForumWarningService warningService = new ForumWarningService();
    private ForumPost postToEdit = null;
    ...
    private void handleSave() {
        ...
        try {
            ...
            System.err.println("[ForumAddPostController] Block check error: " + e.getMessage());
        }
        ...
        if (hasContent) {
            ...
            if (!result.isAllowed()) {
                ...
                ForumWarningService.WarningResult warning = warningService.processViolation(userKey, userEmail, badWord, content);
        ...
        try {
            ...
            if (hasImages) {
                imagePaths = ForumMediaUtils.copyFilesToUploads(selectedImages);
            }
            if (hasVideos) {
                videoPaths = ForumMediaUtils.copyFilesToUploads(selectedVideos);
            }
            ...
            if (postToEdit != null) {
                ...
                showAlert("Succès", "ForumPost modifié avec succès");
            } else {
                postService.ajouter(post);
                showAlert("Succès", "ForumPost publié avec succès");
            }
    ...
    public void setPostToEdit(ForumPost post) {
