...
public class ForumReport {
    ...
    public String toString() {
        return "ForumReport{" + "id=" + id + ", postId=" + postId + ", commentId=" + commentId + ", reporterUserKey='" + reporterUserKey + '\'' + ", reportedUserKey='" + reportedUserKey + '\'' + ", reason='" + reason + '\'' + ", contentType='" + contentType + '\'' + ", createdAt=" + createdAt + ", status='" + status + '\'' + '}';
    }
}
