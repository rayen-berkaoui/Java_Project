...
public class Etablissement {
    ...
    public Etablissement(String nom, String description, String adresse, String ville,
                         String telephone, String email, String horaires, String gammePrix, String type) {
        this.nom = nom;
    ...
    public Integer getIdPartenaire() { return idPartenaire; }
    public void setIdPartenaire(Integer idPartenaire) { this.idPartenaire = idPartenaire; }
}
