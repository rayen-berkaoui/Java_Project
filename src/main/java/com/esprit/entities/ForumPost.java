...
public class ForumPost {
    ...
    public ForumPost(String content, String imagePath, String videoPath, LocalDateTime createdAt, LocalDateTime updatedAt) {
    ...
    public String toString() {
        return "ForumPost{" + "id=" + id + ", content='" + content + '\'' + ", imagePath='" + imagePath + '\'' + ", videoPath='" + videoPath + '\'' + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + '}';
    }
}
